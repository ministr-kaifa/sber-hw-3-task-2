...
public class CollectionUtils {
  ...
  public static <T1 extends Comparable<? super T1>, T2 extends T1, T3 extends T1> 
    List<? extends T1> range(List<? extends T1> list, T2 min, T3 max) {
    return list.stream()
  ...
  // Элементы сравнивать через Comparable.
  // Прмер range(Arrays.asList(8,1,3,5,6, 4), 3, 6) вернет {3,4,5,6}
  public static <T1, T2 extends T1, T3 extends T1>
    List<? extends T1> range(List<? extends T1> list, T2 min, T3 max, Comparator<? super T1> comparator) {
    return list.stream()
